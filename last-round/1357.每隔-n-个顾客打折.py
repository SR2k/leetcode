...
# [1357] 每隔 n 个顾客打折
#
# https://leetcode-cn.com/problems/apply-discount-every-n-orders/description/
#
# algorithms
# Medium (52.39%)
# Likes:    11
...
# cashier.getBill([1,2,3,4,5,6,7],[1,1,1,1,1,1,1]);    // 返回 800.0 ，账单原本为
# 1600.0 ，但由于该顾客是第三位顾客，他将得到 50% 的折扣，所以实际金额为 1600 - 1600 * (50 / 100) = 800 。
...
class Cashier:
    ...
    def getBill(self, product: list[int], amount: list[int]) -> float:
        ...
        c = sum(self.prices[product[i]] * amount[i] for i in range(len(product)))
        if self.count == 0:
            return c - (self.discount * c) / 100
        return c

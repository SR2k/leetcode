...
# [1386] 安排电影院座位
#
# https://leetcode-cn.com/problems/cinema-seat-allocation/description/
#
# algorithms
# Medium (30.92%)
# Likes:    34
...
# @lc code=start
groups = [0b0111100000, 0b0001111000, 0b0000011110]
...
class Solution:
    def maxNumberOfFamilies(self, n: int, reservedSeats: list[list[int]]) -> int:
        ...
        for row, col in reservedSeats:
            if row not in seats_map:
                seats_map[row] = 0
            seats_map[row] |= 1 << (col - 1)

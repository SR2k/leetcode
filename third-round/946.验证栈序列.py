...
# @lc code=end
    ...
    def validateStackSequencesWithDuplicate(self, pushed: list[int], popped: list[int]) -> bool:
        stack = []
...
s = Solution()
print(s.validateStackSequences([1, 2, 7, 2, 3], [2, 3, 7, 2, 1]))
print(s.validateStackSequencesWithDuplicate([1, 2, 7, 2, 3], [2, 3, 7, 2, 1]))

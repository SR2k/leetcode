...
class Node:
    def __init__(self, val: int, prev: 'Node', next: 'Node', child: 'Node'):
        self.val = val
        self.prev = prev
        self.next = next
        self.child = child
...
class Solution:
    def flatten(self, head: 'Node') -> 'Node':
        ...
        # curr = head
        # while curr:
        #     print(f"{curr.prev.val if curr.prev else None} <-- {curr.val} --> {curr.next.val if curr.next else None} # {curr.child.val if curr.child else None}")
        #     curr = curr.next

...
class Solution:
    def rankTeams(self, votes: list[str]) -> str:
        ...
        d: defaultdict[str, list[int]] = defaultdict(lambda: [0 for _ in range(candidate_count)])
        ...
        chars = [c for c in votes[0]]
        chars.sort(key=cmp_to_key(cmp))

...
# @lc code=start
class CacheNode:
    def __init__(self, key: int, val: int, prev: 'CacheNode' = None, next: 'CacheNode' = None) -> None:
        self.key = key
        self.val = val
        self.prev = prev
        self.next = next
...
class LRUCache:
    ...
    def __append(self, node: CacheNode):
    ...
    def __delete(self, node: CacheNode):
